-- Repair seed for operational ontology links.
-- This migration mirrors the applied production repair that normalizes the
-- starter ontology cross-links. It is idempotent and safe to re-run.
